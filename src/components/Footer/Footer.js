  ...
  return (
    <div className="bg-gray-800 py-8 px-6 text-gray-200  lg:text-base text-sm">
      <div className="max-w-screen-xl w-full mx-auto">
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            <div className="md:w-6 w-5  my-auto">
              <Image
                ...
                alt="linkedin"
                onClick={() => {
                  router.push("https://www.linkedin.com/in/mukul-sharma-aa6b36204/");
                }}
              />
            </div>
            <div className="md:w-6 w-5 my-auto">
              <Image
                ...
                className="cursor-pointer"
                alt="github"
                onClick={() => router.push("https://github.com/Mukulsh26")}
              />
            </div>
          </div>
        </div>
        ...
        © 2020 Copyright: 
        <a class="text-white" href = " https://Zinger.com/ "> Zinger.com </a>
        </p>
      </div>
    </div>
  );
